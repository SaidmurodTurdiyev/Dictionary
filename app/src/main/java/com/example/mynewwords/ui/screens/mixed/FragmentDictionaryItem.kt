package com.example.mynewwords.ui.screens.mixed
...
import com.example.mynewwords.databinding.FragmentDictionaryItemBinding
import com.example.mynewwords.ui.dialogs.DialogCountry
import com.example.mynewwords.ui.viewModel.mixed.ViewModelDictionaryItem
...
class FragmentDictionaryItem : Fragment(R.layout.fragment_dictionary_item),
    ...
    private fun setViewModelActions() {
        binding?.buttonBack?.setOnClickListener { viewModel.close() }
